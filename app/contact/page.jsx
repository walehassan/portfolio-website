...
const info = [
  {
    icon: <FaPhoneAlt/>,
    title: "Phone",
    description: "(+234)81 2308 5176"
  },
  {
    icon: <FaEnvelope/>,
    title: "E-mail",
    description: "olawalerae@gmail.com"
  },
  {
    icon: <FaMapMarkedAlt/>,
    title: "Location",
        ...
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">Contact me to help you bring your User Interfaces to life, in a dynamic, responsive and beautiful way</p>
              {/* input */}
